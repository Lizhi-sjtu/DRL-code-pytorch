...
baseline_v0_seed_0 = smooth(np.load('./data_train/REINFORCE_baseline_env_CartPole-v0_number_2_seed_0.npy'))
baseline_v0_seed_10 = smooth(np.load('./data_train/REINFORCE_baseline_env_CartPole-v0_number_2_seed_10.npy'))
baseline_v0_seed_100 = smooth(np.load('./data_train/REINFORCE_baseline_env_CartPole-v0_number_2_seed_100.npy'))

v0_seed_0 = smooth(np.load('./data_train/REINFORCE_env_CartPole-v0_number_2_seed_0.npy'))
v0_seed_10 = smooth(np.load('./data_train/REINFORCE_env_CartPole-v0_number_2_seed_10.npy'))
v0_seed_100 = smooth(np.load('./data_train/REINFORCE_env_CartPole-v0_number_2_seed_100.npy'))
...
baseline_v1_seed_0 = smooth(np.load('./data_train/REINFORCE_baseline_env_CartPole-v1_number_2_seed_0.npy'))
baseline_v1_seed_10 = smooth(np.load('./data_train/REINFORCE_baseline_env_CartPole-v1_number_2_seed_10.npy'))
baseline_v1_seed_100 = smooth(np.load('./data_train/REINFORCE_baseline_env_CartPole-v1_number_2_seed_100.npy'))

v1_seed_0 = smooth(np.load('./data_train/REINFORCE_env_CartPole-v1_number_2_seed_0.npy'))
v1_seed_10 = smooth(np.load('./data_train/REINFORCE_env_CartPole-v1_number_2_seed_10.npy'))
v1_seed_100 = smooth(np.load('./data_train/REINFORCE_env_CartPole-v1_number_2_seed_100.npy'))
