...
drawing_LL(plt, algorithm='Rainbow_DQN', number=6, color=colors[0], label='Rainbow_DQN')

drawing_LL(plt, algorithm='DQN_dueling_Noisy_PER_N_steps', number=6, color=colors[1], label='Rainbow_DQN without Double')

drawing_LL(plt, algorithm='DQN_double_Noisy_PER_N_steps', number=6, color=colors[2], label='Rainbow_DQN without Dueling')

drawing_LL(plt, algorithm='DQN_double_dueling_Noisy_N_steps', number=6, color=colors[3], label='Rainbow DQN without PER')

drawing_LL(plt, algorithm='DQN_double_dueling_Noisy_PER', number=6, color=colors[4], label='Rainbow_DQN without N-steps')

drawing_LL(plt, algorithm='DQN_double_dueling_PER_N_steps', number=6, color=colors[9], label='Rainbow_DQN without Noisy')
