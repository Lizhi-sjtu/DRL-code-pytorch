...
if __name__ == '__main__':
    ...
    parser.add_argument("--random_episodes", type=int, default=20, help=" Maximum number of training steps")
    ...
    parser.add_argument("--epsilon_init", type=float, default=0.5, help="epsilon-greedy")
    parser.add_argument("--epsilon_min", type=float, default=0.1, help="epsilon-greedy")
    parser.add_argument("--epsilon_decay_steps", type=int, default=int(1e5), help="epsilon-greedy")
    ...
    parser.add_argument("--alpha", type=float, default=0.6, help="PER")
    parser.add_argument("--beta_init", type=float, default=0.4, help="IS")
